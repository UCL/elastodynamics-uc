...
\begin{groupplot}[
   ...
   %xlabel= { $\lambda$},
    ...
    \addplot[gray,dashed,thick,forget plot] 
   	table[mark=none,x=ndof,y expr ={9e-0*\thisrowno{10}}] {../data/Convex-Oscillatory-ill-posed-k6-order1.dat}; 
    \addplot[gray,dotted,thick,forget plot] 
   	table[mark=none,x=ndof,y expr ={6e+1*\thisrowno{10}*\thisrowno{10}}] {../data/Convex-Oscillatory-ill-posed-k6-order2.dat}; 
    \addplot[gray,dashdotted,thick,forget plot] 
   	table[mark=none,x=ndof,y expr ={5e+2*\thisrowno{10}*\thisrowno{10}*\thisrowno{10}}] {../data/Convex-Oscillatory-ill-posed-k6-order3.dat}; 
    %\addplot[gray,dashdotted,thick,forget plot] 

...
\begin{groupplot}[
   ...
   %xlabel= { $\lambda$},
    ...
    \addplot[red,very thick,mark=*,dashed] 
   	table[x=ndof,y=L2-error-u-uh-B-minus] {../data/jump-mup2-mum1-ill-posed-k6-order1.dat}; 
    \addplot[blue,very thick,mark=triangle,dashed]  
	table[x=ndof,y=L2-error-u-uh-B-minus] {../data/jump-mup2-mum1-ill-posed-k6-order2.dat}; 
    \addplot[green!70!black,very thick,mark=x,dashed]  
   	table[x=ndof,y=L2-error-u-uh-B-minus] {../data/jump-mup2-mum1-ill-posed-k6-order3.dat}; 
    
    \addplot[gray,dashed,thick,forget plot] 
   	table[mark=none,x=ndof,y expr ={9e-0*\thisrowno{1}}] {../data/jump-mup2-mum1-ill-posed-k6-order1.dat}; 
    \addplot[gray,dotted,thick,forget plot] 
   	table[mark=none,x=ndof,y expr ={6e+1*\thisrowno{1}*\thisrowno{1}}] {../data/jump-mup2-mum1-ill-posed-k6-order2.dat}; 
    \addplot[gray,dashdotted,thick,forget plot] 
   	table[mark=none,x=ndof,y expr ={3e+2*\thisrowno{1}*\thisrowno{1}*\thisrowno{1}}] {../data/jump-mup2-mum1-ill-posed-k6-order3.dat}; 
    ...
    \addplot[red,very thick,mark=*,dashed,forget plot] 
   	table[x=ndof,y=L2-error-u-uh-B-minus] {../data/jump-mup1-mum2-ill-posed-k6-order1.dat}; 
    \addplot[blue,very thick,mark=triangle,dashed,forget plot]  
	table[x=ndof,y=L2-error-u-uh-B-minus] {../data/jump-mup1-mum2-ill-posed-k6-order2.dat}; 
    \addplot[green!70!black,very thick,mark=x,dashed,forget plot]  
   	table[x=ndof,y=L2-error-u-uh-B-minus] {../data/jump-mup1-mum2-ill-posed-k6-order3.dat}; 
    
    \addplot[gray,dashed,thick] 
   	table[mark=none,x=ndof,y expr ={9e-0*\thisrowno{1}}] {../data/jump-mup1-mum2-ill-posed-k6-order1.dat}; 
    \addplot[gray,dotted,thick] 
   	table[mark=none,x=ndof,y expr ={6e+1*\thisrowno{1}*\thisrowno{1}}] {../data/jump-mup1-mum2-ill-posed-k6-order2.dat}; 
    \addplot[gray,dashdotted,thick] 
   	table[mark=none,x=ndof,y expr ={3e+2*\thisrowno{1}*\thisrowno{1}*\thisrowno{1}}] {../data/jump-mup1-mum2-ill-posed-k6-order3.dat}; 

...
\begin{groupplot}[
   ...
   %xlabel= { $\lambda$},
    ...
    \addplot[gray,dashed,thick] 
   	table[mark=none,x=ndof,y expr ={1e-0*\thisrowno{10}}] {../data/Non-Convex-Oscillatory-ill-posed-k4-order1.dat}; 
    \addplot[gray,dotted,thick] 
   	table[mark=none,x=ndof,y expr ={1e+1*\thisrowno{10}*\thisrowno{10}}] {../data/Non-Convex-Oscillatory-ill-posed-k4-order2.dat}; 
    \addplot[gray,dashdotted,thick] 
   	table[mark=none,x=ndof,y expr ={1e+2*\thisrowno{10}*\thisrowno{10}*\thisrowno{10}}] {../data/Non-Convex-Oscillatory-ill-posed-k4-order3.dat}; 

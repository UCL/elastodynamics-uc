...
\begin{groupplot}[
   ...
   %xlabel= { $\lambda$},
	...
	table[x=ndof,y=L2-error-u-uh-B-plus] {../data/SplitGeom-ill-posed-k1-order1-divknown.dat}; 
	...
	table[x=ndof,y=L2-error-u-uh-B-plus] {../data/SplitGeom-ill-posed-k1-order2-divknown.dat}; 
    ...
    \addplot[green!70!black,very thick,mark=x,dashed, forget plot]  
   	table[x=ndof,y=L2-error-u-uh-B-plus] {../data/SplitGeom-ill-posed-k1-order3-divknown.dat}; 
    \addplot[gray,dashed,thick,forget plot] 
   	table[mark=none,x=ndof,y expr ={3e-0*\thisrowno{1}}] {../data/SplitGeom-ill-posed-k1-order2.dat}; 
    \addplot[gray,dashed,thick,forget plot] 
   	table[mark=none,x=ndof,y expr ={1e-1*\thisrowno{1}}] {../data/SplitGeom-ill-posed-k1-order3.dat}; 
    ...
    \addplot[red,very thick,mark=*,dashed,forget plot] 
	table[x=ndof,y=L2-error-u-uh-B-minus] {../data/SplitGeom-ill-posed-k1-order1-divknown.dat}; 
    ...
    \addplot[blue,very thick,mark=triangle,dashed,forget plot]  
	table[x=ndof,y=L2-error-u-uh-B-minus] {../data/SplitGeom-ill-posed-k1-order2-divknown.dat}; 
    ...
    \addplot[green!70!black,very thick,mark=x,dashed, forget plot]  
   	table[x=ndof,y=L2-error-u-uh-B-minus] {../data/SplitGeom-ill-posed-k1-order3-divknown.dat}; 
    ...
    \addplot[gray,dotted,thick] 
   	table[mark=none,x=ndof,y expr ={1e+1*\thisrowno{1}*\thisrowno{1}}] {../data/SplitGeom-ill-posed-k1-order2.dat}; 
    \addplot[gray,dashdotted,thick] 
   	table[mark=none,x=ndof,y expr ={8e+0*\thisrowno{1}*\thisrowno{1}*\thisrowno{1}}] {../data/SplitGeom-ill-posed-k1-order3.dat}; 

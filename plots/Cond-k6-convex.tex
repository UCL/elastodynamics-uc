...
\begin{groupplot}[
   ...
   %xlabel= { $\lambda$},
    ...
    \addplot[red,very thick,mark=*] 
   	table[x=ndof,y=cond] {../data/Convex-Oscillatory-ill-posed-k6-order1.dat}; 
    \addplot[blue,very thick,mark=triangle]  
	table[x=ndof,y=cond] {../data/Convex-Oscillatory-ill-posed-k6-order2.dat}; 
    \addplot[green!70!black,very thick,mark=x]  
   	table[x=ndof,y=cond] {../data/Convex-Oscillatory-ill-posed-k6-order3.dat}; 
    \addplot[gray,dashed,thick] 
	table[mark=none,x=ndof,y expr ={3e2/ (\thisrowno{10}* \thisrowno{10} * \thisrowno{10} * \thisrowno{10}    ) }] {../data/Convex-Oscillatory-ill-posed-k6-order1.dat}; 
    \addplot[gray,dotted,thick] 
	table[mark=none,x=ndof,y expr ={1e2/ ( \thisrowno{10}* \thisrowno{10} * \thisrowno{10} * \thisrowno{10} * \thisrowno{10}  ) }] {../data/Convex-Oscillatory-ill-posed-k6-order1.dat}; 

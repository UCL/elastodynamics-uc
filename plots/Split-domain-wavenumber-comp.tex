...
\begin{groupplot}[
   ...
   %xlabel= { $\lambda$},
	...
	table[mark=none,x=ndof,y expr ={1e+1*\thisrowno{1}}] {../data/SplitGeom-ill-posed-k1-order1.dat}; 
    \addplot[gray,dotted,thick,forget plot] 
   	table[mark=none,x=ndof,y expr ={1e+2*\thisrowno{1}*\thisrowno{1}}] {../data/SplitGeom-ill-posed-k1-order2.dat}; 
    \addplot[gray,dashdotted,thick,forget plot] 
   	table[mark=none,x=ndof,y expr ={8e+2*\thisrowno{1}*\thisrowno{1}*\thisrowno{1}}] {../data/SplitGeom-ill-posed-k1-order1.dat}; 
    ...
    \addplot[red,very thick,mark=*,forget plot] 
   	table[x=ndof,y=L2-error-u-uh-B-minus] {../data/SplitGeom-ill-posed-k6-order1.dat}; 
    \addplot[blue,very thick,mark=triangle,forget plot]  
	table[x=ndof,y=L2-error-u-uh-B-minus] {../data/SplitGeom-ill-posed-k6-order2.dat}; 
    \addplot[green!70!black,very thick,mark=x,forget plot]  
   	table[x=ndof,y=L2-error-u-uh-B-minus] {../data/SplitGeom-ill-posed-k6-order3.dat}; 
    
    \addplot[red,very thick,mark=*,dashed,forget plot] 
   	table[x=ndof,y=L2-error-u-uh-B-plus] {../data/SplitGeom-ill-posed-k6-order1.dat}; 
    \addplot[blue,very thick,mark=triangle,dashed,forget plot]  
	table[x=ndof,y=L2-error-u-uh-B-plus] {../data/SplitGeom-ill-posed-k6-order2.dat}; 
    \addplot[green!70!black,very thick,mark=x,dashed,forget plot]  
   	table[x=ndof,y=L2-error-u-uh-B-plus] {../data/SplitGeom-ill-posed-k6-order3.dat}; 
  
    \addplot[gray,dashed,thick] 
   	table[mark=none,x=ndof,y expr ={8e+0*\thisrowno{1}}] {../data/SplitGeom-ill-posed-k6-order1.dat}; 
    \addplot[gray,dotted,thick] 
   	table[mark=none,x=ndof,y expr ={6e+1*\thisrowno{1}*\thisrowno{1}}] {../data/SplitGeom-ill-posed-k6-order2.dat}; 
    \addplot[gray,dashdotted,thick] 
   	table[mark=none,x=ndof,y expr ={1.5e+2*\thisrowno{1}*\thisrowno{1}*\thisrowno{1}}] {../data/SplitGeom-ill-posed-k6-order3.dat}; 

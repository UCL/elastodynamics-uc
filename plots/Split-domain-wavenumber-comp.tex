...
\begin{groupplot}[
   ...
   %xlabel= { $\lambda$},
	...
	table[mark=none,x=ndof,y expr ={3e+1*\thisrowno{1}}] {../data/SplitGeom-ill-posed-k1-order1.dat}; 
    ...
    \addplot[gray,dashed,thick] 
   	table[mark=none,x=ndof,y expr ={3e+1*\thisrowno{1}}] {../data/SplitGeom-ill-posed-k6-order1.dat}; 
    \addplot[gray,dotted,thick] 
   	table[mark=none,x=ndof,y expr ={3e+2*\thisrowno{1}*\thisrowno{1}}] {../data/SplitGeom-ill-posed-k6-order2.dat}; 
    \addplot[gray,dashdotted,thick] 
   	table[mark=none,x=ndof,y expr ={4e+3*\thisrowno{1}*\thisrowno{1}*\thisrowno{1}}] {../data/SplitGeom-ill-posed-k6-order3.dat}; 

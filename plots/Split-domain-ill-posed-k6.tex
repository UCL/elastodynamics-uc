...
\begin{groupplot}[
   ...
   %xlabel= { $\lambda$},
    ...
    \addplot[gray,dashed,thick,forget plot] 
   	table[mark=none,x=ndof,y expr ={9e-0*\thisrowno{1}}] {../data/SplitGeom-ill-posed-k6-order1.dat}; 
    ...
    \addplot[gray,dashdotted,thick,forget plot] 
   	table[mark=none,x=ndof,y expr ={5e+2*\thisrowno{1}*\thisrowno{1}*\thisrowno{1}}] {../data/SplitGeom-ill-posed-k6-order3.dat}; 
    %\addplot[gray,dashdotted,thick,forget plot] 
    ...
    \addplot[red,very thick,mark=*] 
   	table[x=ndof,y=s-norm] {../data/SplitGeom-ill-posed-k6-order1.dat}; 
    \addplot[blue,very thick,mark=triangle]  
	table[x=ndof,y=s-norm] {../data/SplitGeom-ill-posed-k6-order2.dat}; 
    \addplot[green!70!black,very thick,mark=x]  
   	table[x=ndof,y=s-norm] {../data/SplitGeom-ill-posed-k6-order3.dat}; 
    \addplot[gray,dashed,thick,forget plot] 
   	table[mark=none,x=ndof,y expr ={9e-0*\thisrowno{1}}] {../data/SplitGeom-ill-posed-k6-order1.dat}; 
    \addplot[gray,dotted,thick,forget plot] 
   	table[mark=none,x=ndof,y expr ={6e+1*\thisrowno{1}*\thisrowno{1}}] {../data/SplitGeom-ill-posed-k6-order2.dat}; 
